...
CREATE TABLE `optional` (
  `Op_CCode` bigint NOT NULL,
  `OptionalType` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`Op_CCode`),
  CONSTRAINT `optional_ibfk_1` FOREIGN KEY (`Op_CCode`) REFERENCES `course` (`CCode`)
...
INSERT INTO `optional` VALUES (501003282002,'Technical'),(501003472020,'Technical'),(705004252020,'Non-Technical'),(3201003072020,'Non-Technical');
